...
### Hazard unit ([`src/hazard_unit.sv`](https://github.com/cshieldsce/riscv-5i/blob/main/src/hazard_unit.sv))
...
### Forwarding unit ([`src/forwarding_unit.sv`](https://github.com/cshieldsce/riscv-5i/blob/main/src/forwarding_unit.sv))
