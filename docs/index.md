...
<section class="hero">
  <div class="hero-text">
    ...
    <p class="hero-links">
      ...
      <a href="https://github.com/cshieldsce/riscv-5i">Source on GitHub</a>
    </p>
  </div>
  <div class="hero-figure">
    <img src="{{ '/images/pipeline_complete.svg' | relative_url }}"
         alt="riscv-5i datapath: five pipeline stages with forwarding paths and hazard logic">
  </div>
</section>
