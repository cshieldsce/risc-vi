...
- Top module: [`src/pynq_z2_top.sv`](https://github.com/cshieldsce/riscv-5i/blob/main/src/pynq_z2_top.sv)
...
<div class="img-wrapper screenshot">
  ...
  <span class="caption">Post-implementation placement on the Zynq-7000 fabric. The lit-up region shows the riscv-5i core; the rest of the device is unused.</span>
</div>
...
- Bitstream and synthesis scripts live under [`fpga/`](https://github.com/cshieldsce/riscv-5i/tree/main/fpga) in the repo.
- The Fibonacci hex image used above: [`test/mem/fib_test.mem`](https://github.com/cshieldsce/riscv-5i/blob/main/test/mem/fib_test.mem).
